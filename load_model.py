...
def predict(parameters, X):
	...
	z1 = tf.nn.relu(training.conv2d(x, W_conv1) + b_conv1)
	maxpool1 = training.max_pool_2x2(z1)
	z2 = tf.nn.relu(training.conv2d(maxpool1, W_conv2) + b_conv2)
	maxpool2 = training.max_pool_2x2(z2)
...
def img_to_mat(picname):
	im = Image.open("new_picture//{}".format(picname))
